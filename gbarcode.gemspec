...
PKG_FILES = ['ext/barcode_wrap.c', 'ext/codabar.c', 'ext/code128.c', 'ext/code39.c', 'ext/code93.c', 'ext/ean.c', 'ext/i25.c', 'ext/library.c', 'ext/msi.c', 'ext/pcl.c', 'ext/plessey.c', 'ext/ps.c', 'ext/svg.c', 'ext/barcode.h', 'ext/extconf.rb']
